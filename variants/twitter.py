...
# a source is a container for the data-producing resources, it returns parametrized resources
@dlt.source
...
# Example sources: API endpoint, a database table, a file, or a sheet from a gsheets workbook...
@dlt.resource(write_disposition="append")
def twitter_resource(twitter_bearer_token=dlt.secrets.value):
...
if __name__=='__main__':
    ...
    # p = dlt.pipeline(pipeline_name="tester", destination="bigquery", dataset="tester_data")
